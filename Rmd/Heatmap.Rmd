...
plot_cluster_select <- 
  ...
  geom_rect(aes(ymin = ymin, ymax = ymax, fill = cluster_select),
            # fill = "grey50",
            xmin = -0.1, xmax = 0) +
...
```{r combine_dendrogram_heatmap_clusters, fig.height = 6, fig.width = 7}
plot_dh_cluster_nolegend <- 
  plot_grid(plot_dendrogram_log2FC_m1,
          plot_log2FC_m1_dorder +
            theme(axis.title.y = element_blank(),
...
ggsave(filename = "../results/clustered_heatmap_GAT201ConditionTime.pdf", width = 6, height = 6)
...
```{r plot_log2FC_line_multipanel, fig.height = 6, fig.width = 3}
log2FC_line_multipanel <- 
  plot_grid(
    lineplot_CQS1 + theme(legend.position = "none"),
    lineplot_SSA1 + theme(legend.position = "none"),
    lineplot_GAT201 + theme(legend.position = "none"),
    lineplot_TSA3 + theme(legend.position = "none"),
    lineplot_TEF1 + theme(legend.position = "none"),
    get_legend(lineplot_CQS1 + 
                 guides(col = 
                          guide_legend(
                            title.position = "left",
                            ncol = 2)) + 
                 theme(#legend.title = element_blank(),
                   legend.box.margin = 
                     margin(0, 0, 0, 1, unit = "cm"))
    ),
    ncol = 1, rel_heights = c(1,1,1,1,1, .5))
log2FC_line_multipanel

ggsave(filename = "../results/log2FC_line_multipanel_representative.pdf",
       width = 3, height = 6)
```
