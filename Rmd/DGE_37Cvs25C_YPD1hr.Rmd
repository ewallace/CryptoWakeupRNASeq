...
Differential Gene Expression of 37C vs 25C in YPD samples using DESeq2
...
Check that - cutoff might miss an interesting group of genes e.g. downregulated ribosomal proteins.
