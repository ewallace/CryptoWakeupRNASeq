...
The repository contains a pipeline to process from reads to counts-per-mRNA, and a directory structure for many steps of data analysis, quality control using R/Rmarkdown, differential expression analysis, results, figures, etc.
...
The pipeline worked from local copies on the bifx server.
